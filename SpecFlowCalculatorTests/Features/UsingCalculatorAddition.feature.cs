...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("Addition")]
        [NUnit.Framework.TestCaseAttribute("0.1", "0.11", "7", null)]
        [NUnit.Framework.TestCaseAttribute("0.10", "0.11", "11", null)]
        [NUnit.Framework.TestCaseAttribute("0.11", "0.11", "15", null)]
...
#line hidden
#line 17
    testRunner.When(string.Format("I have entered binary {0} and {1} into the calculator and press add", value1, value2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 18
